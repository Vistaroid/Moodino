...
@Database(version = 1, exportSchema = false, entities = [Entry::class, Activity::class, Category::class])
...
abstract class AppDatabase : RoomDatabase() {
    ...
    abstract val getCategoryDao : CategoryDao
    abstract val getActivityDao : ActivityDao
}