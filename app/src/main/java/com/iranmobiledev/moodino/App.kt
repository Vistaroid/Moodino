...
class App : Application() , KoinComponent{
    ...
    private fun makeActivities() {
        ...
        categories.forEach {
            ...
            activityDao.addActivity(Activity(null,id,resources.getResourceEntryName(R.drawable.ic_friends),resources.getResourceEntryName(R.string.friends)))
            activityDao.addActivity(Activity(null,id,resources.getResourceEntryName(R.drawable.ic_date), resources.getResourceEntryName(R.string.mDate)))
            activityDao.addActivity(Activity(null,id,resources.getResourceEntryName(R.drawable.ic_gaming), resources.getResourceEntryName(R.string.gaming)))
            activityDao.addActivity(Activity(null,id,resources.getResourceEntryName(R.drawable.ic_movie), resources.getResourceEntryName(R.string.movie)))
            activityDao.addActivity(Activity(null,id,resources.getResourceEntryName(R.drawable.ic_reading), resources.getResourceEntryName(R.string.reading)))
            activityDao.addActivity(Activity(null,id,resources.getResourceEntryName(R.drawable.ic_relax), resources.getResourceEntryName(R.string.relax)))
            activityDao.addActivity(Activity(null,id,resources.getResourceEntryName(R.drawable.ic_shopping), resources.getResourceEntryName(R.string.shopping)))
            activityDao.addActivity(Activity(null,id,resources.getResourceEntryName(R.drawable.ic_sleep), resources.getResourceEntryName(R.string.sleep)))
            activityDao.addActivity(Activity(null,id,resources.getResourceEntryName(R.drawable.ic_cleaning), resources.getResourceEntryName(R.string.cleaning)))
            activityDao.addActivity(Activity(null,id,resources.getResourceEntryName(R.drawable.ic_brain), resources.getResourceEntryName(R.string.mLearn)))
        }
    }
}